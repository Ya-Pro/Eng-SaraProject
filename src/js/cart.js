...
function addProductToCart() {
  ...
  if (itemsAdded.find((el) => el.title == newToAdd.title)) {
    ...
    popupP.innerHTML = `Your order has been successfully added to the cart. you can increase the amount !`;
...
buyBtn.addEventListener("click", () => {
  if (itemsAdded.length <= 0) {
    ...
    let popupP = popup.querySelector("p");
    popup.firstElementChild.style.display = "none";
    popup.lastElementChild.style = "background-color:purple;";
    popupP.innerHTML = `Your Products Are ready for buying them now  !`;
    popupButton.addEventListener("click", () => {
